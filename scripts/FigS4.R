## this script plots boxplots from bulk analysis (non-expanded)
## legacy bulk_analysis_plot.R from Martina's git

library(ggplot2)
library(reshape)

alpha_ss<-readRDS("data/output_data/all_A_bulk_analysis_subsampled.RData")
beta_ss<-readRDS("data/output_data/all_B_bulk_analysis_subsampled.RData")
