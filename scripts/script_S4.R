### this script calculate richness and diversity
### then saves the results, so they can be plotted by a separate script
### I do this for both non-subsampled and subsampled bulk
...
i_J<-which(all_A_long$j_call=="TRAJ12" | exp_AB_wide1$j_call=="TRAJ20" |exp_AB_wide1$j_call=="TRAJ33")
